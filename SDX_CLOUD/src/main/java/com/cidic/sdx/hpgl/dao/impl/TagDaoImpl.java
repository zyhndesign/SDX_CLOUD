...
import com.cidic.sdx.hpgl.dao.TagDao;
	...
	public void updateTag(String key, String old_value, String new_value) {
		redisTemplate.execute(new RedisCallback<Object>() {
			...
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				...
				connection.hSet(ser.serialize("hp:" + tempKey[1]),
						ser.serialize(tempKey[0].substring(4, tempKey[0].length())), ser.serialize(new_value));
	...
	public List<Map<String, String>> getAllTag() {
		return redisTemplate.execute(new RedisCallback<List<Map<String, String>>>() {
			...
			public List<Map<String, String>> doInRedis(RedisConnection connection) throws DataAccessException {
				...
				Map<byte[], byte[]> categoryMapList = connection.hGetAll(
						ser.serialize(RedisVariableUtil.CATEGORY_PREFIX + RedisVariableUtil.DIVISION_CHAR + "0"));
