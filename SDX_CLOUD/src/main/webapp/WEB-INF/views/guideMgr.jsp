		...
		<div class="right">
			<div class="panel panel-default">
				...
				<div class="panel-body" id="opt-body">
					<div class="row">
						<a class="btn btn-primary newBtn" href="dggl/appUser/guideCOU"> <span class="glyphicon glyphicon-plus"></span> 新建
						</a>

						<div class="input-group tableSearchContainer col-md-6">
							<input class="form-control" id="searchName" type="text" placeholder="姓名"> <span class="input-group-btn">
