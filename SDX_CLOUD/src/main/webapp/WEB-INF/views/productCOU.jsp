				...
				<div class="panel-body" id="opt-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-9 input-group">
								<input type="text" id="category" class="form-control" value="${hp.categoryList}"> <input type="hidden" id="categoryId" name="category"
									value="${hp.category}">
								<c:if test="${!empty hp.id}">
						...
						<div class="form-group">
							...
							<div class="col-md-9 input-group">
								<input type="text" id="size" class="form-control" value="${hp.sizeList}"> <input type="hidden" id="sizeId" name="size" value="${hp.size}">
								<c:if test="${!empty hp.id}">
						...
						<div class="form-group">
							...
							<div class="col-md-9 input-group">
								<input type="text" id="color" class="form-control" value="${hp.colorList}"> <input type="hidden" id="colorId" name="color" value="${hp.color}">
								<c:if test="${!empty hp.id}">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9" id="uploadContainer">
								...
								<a href="#" id="uploadBtn1"> <c:if test="${empty hp.imageUrl1}">
										<img id="image1" class="imgThumb" style="width: 100px" src="resources/images/app/defaultThumb.png" />
										<input type="hidden" id="imageUrl1" name="imageUrl1">
									</c:if> <c:if test="${!empty hp.imageUrl1}">
										<img id="image1" class="imgThumb" style="width: 100px" src="${hp.imageUrl1}" />
								...
								<a href="#" id="uploadBtn2"> <c:if test="${empty hp.imageUrl2}">
										<img id="image2" class="imgThumb" style="width: 100px" src="resources/images/app/defaultThumb.png" />
										<input type="hidden" id="imageUrl2" name="imageUrl2">
									</c:if> <c:if test="${!empty hp.imageUrl2}">
										<img id="image2" class="imgThumb" style="width: 100px" src="${hp.imageUrl2}" />
								...
								<a href="#" id="uploadBtn3"> <c:if test="${empty hp.imageUrl3}">
										<img id="image3" class="imgThumb" style="width: 100px" src="resources/images/app/defaultThumb.png" />
										<input type="hidden" id="imageUrl3" name="imageUrl3">
									</c:if> <c:if test="${!empty hp.imageUrl3}">
										<img id="image3" class="imgThumb" style="width: 100px" src="${hp.imageUrl3}" />
